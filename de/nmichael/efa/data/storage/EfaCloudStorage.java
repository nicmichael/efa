...
public class EfaCloudStorage extends XMLFile {
     ...
     */
    public EfaCloudStorage(String efaCloudURL, String directory, String storageUsername, String storagePassword,
                           String filename, String extension, String description) throws
            EfaException {
        super(directory, filename, extension, description);
        this.txQueue = TxRequestQueue.getInstance(efaCloudURL, storageUsername, storagePassword, directory);
