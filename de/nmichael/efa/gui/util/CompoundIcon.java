...
/* Compound icon by Tips4Java Licensed under MIT License
 * 
...
public class CompoundIcon implements Icon {
	...
	/**
	 * Convenience contructor for creating a CompoundIcon where the icons are layed
	 * out on on the X-AXIS, the gap is 0 and the X/Y alignments will default to
	 * CENTER.
	 *
	...
	/**
	 * Convenience contructor for creating a CompoundIcon where the gap is 0 and the
	 * X/Y alignments will default to CENTER.
	 *
	 * @param axis  the axis used to lay out the icons for painting. Must be one of
	...
	public CompoundIcon (Axis axis, int gap, float alignmentX, float alignmentY, Vector<Icon> vIcons) {
		...
		this.icons = vIcons.toArray(this.icons);
	...
	/**
	 * Get IconInformation at the specified point for a given component. The icon
	 * information will include the icon, the bounds of the icon and the Point
	 * relative to the icon. null is returned when no icon is found at the specified
	 * point.
	 *
	 ...
	 * CompoundIcon. The bounds will always be returned for the specified Icon. The
	 * relative point is only returned when a lookup for a single Icon was done for
	 * a specific point. Otherwise (0, 0) is returned.
	 */
