...
public class Daten {
    ...
    public final static String VERSION            = "2.3.4 Beta Flatlaf"; // Version für die Ausgabe (z.B. 2.1.0, kann aber auch Zusätze wie "alpha" o.ä. enthalten)
    public final static String VERSIONID          = "2.3.4_#2";   // VersionsID: Format: "X.Y.Z_MM"; final-Version z.B. 1.4.0_00; beta-Version z.B. 1.4.0_#1
    public final static String VERSIONRELEASEDATE = "03.01.2024";  // Release Date: TT.MM.JJJJ
