...
public class Daten {
    ...
    public final static String VERSION            = "2.3.4_00"; // Version für die Ausgabe (z.B. 2.1.0, kann aber auch Zusätze wie "alpha" o.ä. enthalten)
    ...
    public final static String VERSIONRELEASEDATE = "06.11.2023";  // Release Date: TT.MM.JJJJ
