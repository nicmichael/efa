...
public class Daten {
    ...
    public final static String VERSION            = "2.2.2_SGB_fix_#1a,2,3,5,15,16"; // Version für die Ausgabe (z.B. 2.1.0, kann aber auch Zusätze wie "alpha" o.ä. enthalten)
    public final static String VERSIONID          = "2.2.2_40";   // VersionsID: Format: "X.Y.Z_MM"; final-Version z.B. 1.4.0_00; beta-Version z.B. 1.4.0_#1
    public final static String VERSIONRELEASEDATE = "08.09.2019";  // Release Date: TT.MM.JJJJ
    ...
    public final static String COPYRIGHTYEAR      = "19";   // aktuelles Jahr (Copyright (c) 2001-COPYRIGHTYEAR)
