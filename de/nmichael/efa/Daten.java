...
public class Daten {
    ...
    public final static String VERSION            = "2.3.3_01_UmlautsucheV2"; // Version für die Ausgabe (z.B. 2.1.0, kann aber auch Zusätze wie "alpha" o.ä. enthalten)
    public final static String VERSIONID          = "2.3.3_01";   // VersionsID: Format: "X.Y.Z_MM"; final-Version z.B. 1.4.0_00; beta-Version z.B. 1.4.0_#1
    public final static String VERSIONRELEASEDATE = "15.10.2023";  // Release Date: TT.MM.JJJJ
