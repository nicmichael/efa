...
public class Daten {
    ...
    public final static String VERSION            = "2.2.2_43_SGB_fix_#1a,2,3,5,15,16"; // Version für die Ausgabe (z.B. 2.1.0, kann aber auch Zusätze wie "alpha" o.ä. enthalten)
    public final static String VERSIONID          = "2.2.2_43";   // VersionsID: Format: "X.Y.Z_MM"; final-Version z.B. 1.4.0_00; beta-Version z.B. 1.4.0_#1
    public final static String VERSIONRELEASEDATE = "02.04.2020";  // Release Date: TT.MM.JJJJ
